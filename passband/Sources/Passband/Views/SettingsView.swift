...
///
/// Threads: the shape the reader draws a conversation in, as a DEFAULT, with
/// Automatic reading each thread as it opens (ThreadStyle.automatic). A thread
/// switched by hand keeps its own answer for good and stops following this.
